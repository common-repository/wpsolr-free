...
class WPSOLR_Admin_UI_Ajax_Media_Content_Upload extends WPSOLR_Admin_UI_Ajax_Search {
	...
	public static function extract_parameters() {
		...
		$parameters = array(
			self::PARAMETER_POST_ID      => sanitize_text_field( empty( $_GET[ self::PARAMETER_POST_ID ] ) ? '' : $_GET[ self::PARAMETER_POST_ID ] ),
			self::PARAMETER_POST_TITLE   => sanitize_text_field( empty( $_GET[ self::PARAMETER_POST_TITLE ] ) ? '' : $_GET[ self::PARAMETER_POST_TITLE ] ),
			self::PARAMETER_POST_CONTENT => sanitize_text_field( empty( $_GET[ self::PARAMETER_POST_CONTENT ] ) ? '' : $_GET[ self::PARAMETER_POST_CONTENT ] ),
		);
