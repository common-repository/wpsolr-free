...
class WPSOLR_AI_Text_Api_Rosette_Sentiment extends WPSOLR_AI_Text_Api_Abstract {

	const API_ID = 'text_rosette_sentiment';
	...
	public function get_label() {
		return static::TEXT_SERVICE_EXTRACTION_SENTIMENT['label'];
	}
