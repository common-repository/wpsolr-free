	...
	static function get_default_options() {
		...
		return [
			...
			self::TERMS           => [
				...
				WPSOLR_SearchSolariumClient::SORT_CODE_BY_NUMBER_COMMENTS_DESC => self::_x( WPSOLR_SearchSolariumClient::SORT_CODE_BY_NUMBER_COMMENTS_DESC, 'The more commented', 'Sort list element', 'wpsolr' ),
				WPSOLR_SearchSolariumClient::SORT_CODE_BY_NUMBER_COMMENTS_ASC  => self::_x( WPSOLR_SearchSolariumClient::SORT_CODE_BY_NUMBER_COMMENTS_ASC, 'The least commented', 'Sort list element', 'wpsolr' ),
				...
				'facets_show_more'                                             => self::_x( 'facets_show_more', 'Show more', 'Link "Show more"', 'wpsolr' ),
				'facets_show_less'                                             => self::_x( 'facets_show_less', 'Show less', 'Link "Show less"', 'wpsolr' ),
				/* Results header */
